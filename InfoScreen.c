...
void InfoScreen_addLine(InfoScreen* this, const char* line) {
   ...
   if (!IncSet_filtering(this->inc) || IncSet_matchFilter(this->inc, line)) {
...
void InfoScreen_appendLine(InfoScreen* this, const char* line) {
   ...
   if ( IncSet_filtering(this->inc)
      && Panel_get(this->display, Panel_size(this->display) - 1) != (Object*)last
      && IncSet_matchFilter(this->inc, line) ) {
